...
origin_prompt = '''
This is a puzzle task. Try to restore the image and answer the question: [xxxx]. You will get a keyword from the image. 
...
Do not give me simple replies; answer the questions in detail.
'''
